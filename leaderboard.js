...
const Leaderboard = () => {
  const leaderboardData = [
    { rank: 1, name: 'John Doe', points: 100, photo: require('./images/pic1.png') },
    { rank: 2, name: 'Jane Smith', points: 95, photo: require('./images/pic1.png') },
    { rank: 3, name: 'Alice Johnson', points: 90 ,photo: require('./images/pic1.png') },
    { rank: 4, name: 'Bob Brown', points: 85 ,photo: require('./images/pic1.png') },
    { rank: 5, name: 'Emma Davis', points: 80 ,photo: require('./images/pic1.png') },
    { rank: 6, name: 'Michael Wilson', points: 75,photo: require('./images/pic1.png')  },
    { rank: 7, name: 'Sophia Lee', points: 70,photo: require('./images/pic1.png')  },
    { rank: 8, name: 'Matthew Taylor', points: 65,photo: require('./images/pic1.png')  },
    { rank: 9, name: 'Olivia Anderson', points: 60,photo: require('./images/pic1.png')  },
    { rank: 10, name: 'Daniel Martinez', points: 55,photo: require('./images/pic1.png')  },
  ];
